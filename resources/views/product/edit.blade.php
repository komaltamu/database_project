...
<body>
    ...
    @endif
     ...
     <form action="{{route('update', $product)}}" method="post">
        @csrf
        <div>
            <input type="text" name="name" value="{{ $product->name }}" id="datepicker" placeholder="Product Name" />
            @error('name')
                <span
        ...
        <div>
            <input type="text" name="price" value="{{ $product->price }}" id="datepicker" placeholder="Product Price" />
            @error('price')
                <span
                    class="form-text text-danger">{{ $message }}</span>
            @enderror
        ...
        <div>
            ...
            <input type="text" name="quantity" value="{{ $product->quantity }}" id="datepicker" placeholder="Product Quantity" />
            @error('quantity')
                <span
                    class="form-text text-danger">{{ $message }}</span>
            @enderror
        </div>
            <input type="btn btn-dark submit" value="submit">
    </form>
